...
abstract contract StarknetTokenStorage {
    ...
    function l2TokenBridge() public view returns (uint256) {
    ...
    // Storage Setters.
    function bridgedToken(address contract_) public {
    ...
    function messagingContract(IStarknetMessaging contract_) public {
